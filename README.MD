...
# Genera una clave aleatoria larga (ej: desde https://randomkeygen.com/)
...
3.  Haz clic derecho en tu archivo `index.html` (o el de login) y selecciona **"Open with Live Server"**.
